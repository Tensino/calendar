...
public class SimpleActivity extends AppCompatActivity implements CalendarView.OnCalendarSelectListener,View.OnClickListener{
    Calendar temporary;
    ...
    public DBclass DB = new DBclass(SimpleActivity.this, "Schedule", null, 1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerView pvTime = new TimePickerBuilder(SimpleActivity.this, new OnTimeSelectListener() {
                    @Override
        ...
        Intent in = new Intent(SimpleActivity.this, MyIntentService.class);
        ...
        if (isClick) {
            ...
            builder.setPositiveButton("添加事件", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Intent intent = new Intent(SimpleActivity.this,AddActivity.class);
